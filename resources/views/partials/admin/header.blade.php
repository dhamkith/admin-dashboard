                  ...
                  <div class="buttons">
                    <div class="navbar-item  is-tab has-dropdown is-hoverable">
                        ...
                        <div class="navbar-dropdown"> 
                          <a href="#" class=" navbar-item ">notification massege</a>
                          <hr class="navbar-divider">
                          <a href="#" class=" navbar-item ">subject</a> 
                        </div> 
                      </div>
                      <div class=" navbar-item  is-tab has-dropdown is-hoverable ">
                          <a class="navbar-link has-dropdown-mobile" href="#">
                              <div class="img" style="background-image: url('/storage/admin/picture/user.png"></div>
                          </a>
                          <div class="navbar-dropdown">
                              <hr class="navbar-divider">
